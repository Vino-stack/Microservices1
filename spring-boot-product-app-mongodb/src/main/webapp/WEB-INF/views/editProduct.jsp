...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
 ...
 <div>
<form:form   modelAttribute="product" action="/spring-product-web-mvc/spring/updatep" method="post">
...
<td>${p.pprice}</td>
<td align="center">
<a href="/spring-product-web-mvc/spring/editp/${p.pid}">
<input type="button" value="EDIT" class="btn btn-info">
</a> 
</td>
<td>
<a href="/spring-product-web-mvc/spring/deletep?id=${p.pid}">
